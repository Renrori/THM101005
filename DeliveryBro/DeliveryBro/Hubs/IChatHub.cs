...
namespace DeliveryBro.Hubs
{
	public interface IChatHub
	{
		...
		Task ToAdminMessage(string connectionID,string guid,string name,string role, string message);
		Task ToStoreMessage(string connectionID, string guid, string name, string role, string message);
