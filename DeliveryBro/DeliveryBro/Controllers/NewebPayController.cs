...
namespace DeliveryBro.Controllers
{
    public class NewebPayController :Controller
    {
        private BankInfoModel _bankInfoModel = new BankInfoModel
        {
            ...
            ReturnURL = "https://localhost:7163/Api/CallBackURLApi",
        ...
        public NewebPayController(sql8005site4nownetContext context)
        {
            _context = context;
        }

        [HttpPost]
        public async Task SpgatewayPayBillAsync(string orderid, int amount, string payType, string email)
        {
            var od = _context.CustomerOrderTable.FirstOrDefault(o => o.OrderId == int.Parse(orderid));
            string version = "1.5";
            ...
            TradeInfo tradeInfo = new TradeInfo()
            {
                ...
                EmailModify = 0,
                // 商店備註
                OrderComment = od.Restaurant.RestaurantDescription,
